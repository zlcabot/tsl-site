...
successions, so that with no events there is no time. Most modern
debate is still a descendant of this quarrel.

McTaggart's two series. In 1908 J.M.E. McTaggart split time-talk
into the A-series (past, present, future: tensed, flowing) and the
B-series (earlier-than and later-than: tenseless, fixed), then
argued the A-series is contradictory and time therefore unreal.
Analytic philosophy of time has been sorting the wreckage since:
presentism holds that only the present exists, eternalism that all
times are equally real in a "block universe," the growing-block
view that past and present are real while the future is not yet.

Relativity. Einstein removed the universal now. Simultaneity is
relative to the observer's frame, and clocks in motion or in
...
assumption, the idea that time is something happenings are in,
whether that something is absolute (Newton), relational scaffolding
...
The full walk is [[what-is-time|What is time?]] The verb underneath
is [[tending]].
